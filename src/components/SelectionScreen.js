        ...
        {(isTimeTrial === null) && (
            ...
            <fieldset onChange={(e) => setCurrentSelection(e.target.value)} className="mobile-mb-2">
                ...
                <div class="grid-container columns-2">
                    ...
                    <Card title={"Non-timed"} body={"Play a round of 20 questions. Each question will be totally visible at the start of each round and the question timer will load in with the question. This mode presents follow-up questions for each correct question."} makeSelection={setCurrentSelection} value={"false"} currentSelection={currentSelection} />
                </div>
